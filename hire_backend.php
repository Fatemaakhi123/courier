...
require 'includes/Exception.php';
    ...
    if (isset($_POST['submit']) ) {
        ...
        $code = mysqli_real_escape_string($conn, md5(rand()));
                ...
                $sql1 = "INSERT INTO hire(name,phone,nid,location,type,license,duration,date,code) VALUES ('{$name}', '{$phone}','{$nid}','{$location}','{$type}','{$license}','{$duration}','{$date}','{$code}')";
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = ' Confirmation Id <br><button type="button" style="padding:1rem; margin-left:12rem;border-radius:1rem;"><a style="text-decoration:none;font-weight:bold; color:black;" href="http://localhost/courier/hire_reciet.php?verification='.$code.'">Confirm</a></button>';
