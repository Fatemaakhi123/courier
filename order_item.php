...
<head>
    ...
    <style>
 .backphoto{
    background-image:linear-gradient(to bottom, rgba(251, 250, 252, 0.4), rgba(251, 250, 252,0.4)),url(./images/pexels-karolina-grabowska-4210786.jpg);
...
<label for="weight"><b>Aproximate Weight:</b></label>
    <select name="select1">
        <option value="100tk">2kg</option>
        <option value="200tk">5kg</option>
        <option value="250tk">10kg</option>
        <option value="300tk">20kg</option>
        <option value="400tk">upto 20kg</option>
    </select>
   <br><br>
...
<option disabled selected>select delivery area</option>
    ...
    <optgroup label="Category C">
        ...
        <button type="submit" name="sub" style="margin-top:1rem;">Place order</button><br>
