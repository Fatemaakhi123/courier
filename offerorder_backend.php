...
require 'includes/Exception.php';
    ...
    if (isset($_POST['sub'])) {
        ...
        $code = mysqli_real_escape_string($conn, md5(rand()));
                ...
                $sql = "INSERT INTO sale(select1,element,address,pickup,delivery,Coupon_Code,code) VALUES ('{$select1}', '{$element}','{$address}','{$pickup}','{$delivery}','{$Coupon_Code}','{$code}')";
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = ' Confirmation Id <br><button type="button" style="padding:1rem; margin-left:12rem;border-radius:1rem;"><a style="text-decoration:none;font-weight:bold; color:black;" href="http://localhost/courier/confirm_offer.php?verification='.$code.'">Confirm</a></button>';
